...
export default function DetailBox({children, media_type, id}) {
  ...
  return (
    <div>
      <div className="flex-col bg-[#7a8185] hover:bg-[#7F95A2] hover:[text-shadow:_1px_2px_0_rgb(163_163_163/_100%)] w-56 rounded-xl px-2 pt-2 pb-1 pointer " onClick={handleOpen} color="inherit" >{children}</div>
      <Modal
